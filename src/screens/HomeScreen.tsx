...
import { FlatList, Image, ImageBackground, ScrollView, Text, TouchableOpacity, View, useColorScheme } from 'react-native'
...
function HomeScreen() {
    ...
    const { user, getDesigns, designs_user } = useContext(AuthContext);
